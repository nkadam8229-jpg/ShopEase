...
CREATE TABLE `traffic_events` (
  ...
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `idx_traffic_visitor` (`visitor_id`),
  ...
  KEY `idx_traffic_category` (`category_id`),
  KEY `idx_traffic_subcategory` (`subcategory_id`),
  CONSTRAINT `fk_traffic_category` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_traffic_product` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_traffic_subcategory` FOREIGN KEY (`subcategory_id`) REFERENCES `subcategories` (`id`) ON DELETE SET NULL,
...
-- Dump completed on 2026-08-15  8:02:29
